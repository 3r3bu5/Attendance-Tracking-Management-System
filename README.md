...
- **The system automatically creates full attendance entry daily at the end of the working day** to track the availability of all users at each day and count the absence days of the users.
